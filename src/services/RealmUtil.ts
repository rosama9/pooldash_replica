...
const PoolProps = ['name', 'gallons', 'waterType', 'wallType', 'objectId', 'formulaId', 'email', 'poolDoctorId', 'importMethod'];
const LogEntryProps = ['objectId', 'poolId', 'userTS', 'clientTS', 'serverTS', 'readingEntries', 'treatmentEntries', 'formulaId', 'formulaName', 'notes', 'poolDoctorId', 'importMethod'];
