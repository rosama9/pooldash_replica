...
import { LogEntryV5 } from '~/models/logs/LogEntry/LogEntryV5';
...
import { PoolV4 } from '~/models/Pool/PoolV4';
...
const schemas: Realm.Configuration[] = [
    ...
    {
        schema: [PoolV4.schema, LogEntryV5.schema, ReadingEntryV2.schema, TreatmentEntryV2.schema, TargetRangeOverrideV2.schema],
        schemaVersion: 8,
    },
];
